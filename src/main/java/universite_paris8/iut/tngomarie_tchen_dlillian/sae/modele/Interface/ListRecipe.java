...
public class ListRecipe {
    ...
    //Arc (3 batons + 3 fils = 1 arc)
        int[][] n1 = new int[][] {{28,3},{32,3}}; // 3 batons (ID 28) + 3 fils (ID 32)
        int[][] o1 = new int[][] {{8,1}};         // 1 arc (ID 8)
        list.put(0, new Recipe(n1, o1));
    //Fleche (2 batons + 1 pierre = 3 fleches)
        int[][] n2 = new int[][] {{28,2},{1,1}};  // 2 batons (ID 28) + 1 pierre (ID 1)
        int[][] o2 = new int[][] {{9,3}};         // 3 fleches (ID 9)
        list.put(1, new Recipe(n2, o2));
    //Epee Bois (1 baton + 2 bois = 1 épée bois)
        int[][] n3 = new int[][] {{28,1},{0,2}};  // 1 baton (ID 28) + 2 bois (ID 0)
        int[][] o3 = new int[][] {{10,1}};        // 1 épée bois (ID 10)
        list.put(2, new Recipe(n3, o3));

    //Pioche Bois (2 batons + 3 bois = 1 pioche bois)
        int[][] n4 = new int[][] {{28,2},{0,3}};  // 2 batons (ID 28) + 3 bois (ID 0)
        int[][] o4 = new int[][] {{14,1}};        // 1 pioche bois (ID 14)
